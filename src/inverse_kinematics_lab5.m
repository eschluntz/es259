function [theta1, theta2, theta3, theta4, theta5] = inverse_kinematics_lab5(x_tool, y_tool, z_tool)
% inverse kinematics for use with computer vision
...
oc = [(x_tool - (2+6/2.54)*cos(theta1));(y_tool - (2+6/2.54)*sin(theta1));(z_tool+15/2.54)];
